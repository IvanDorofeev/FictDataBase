...
firstName=["Владислав","Александр","Иван","Игорь","Олег","Ярослав",
   "Николай","Алексей","Андрей","Виктор"]
lastName=["Дорофеев","Тараканов","Кузнецов","Дедов","Кожемякин","Барсуков",
   "Порядин","Донских","Анохин","Иванов"]
gender=["ж","м"]
